...
var users = [];
exports.postRegister = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, newUser, e_1;
...
exports.postLogin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email_1, password, user, userPass, passwordMatch, token, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, bcrypt.compare({ password: password, userPass: userPass })];
            case 1:
                passwordMatch = _b.sent();
                if (!passwordMatch) {
                    return [2 /*return*/, res.status(400).json({ message: "password does not match" })];
                }
                token = jwt.sign({ username: user.email }, process.env.JWT_SECRET, {
                    expiresIn: "1h",
                });
